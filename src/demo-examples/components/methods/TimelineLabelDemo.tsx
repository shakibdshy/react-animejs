      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="px-3 py-1.5 bg-demo-card hover:bg-slate-700 text-slate-300 rounded-md transition-colors text-xs"
          >
            {"Seek 'start'"}
          </button>
          <button
