  ...
  return (
    <AnimeTimeline autoplay={false} entries={entries}>
      {({ controls, state }) => (
        ...
        {/* Shapes display area */}
            <div className="bg-demo-card p-6 rounded-xl border border-demo-border relative min-h-35 flex items-end gap-4 justify-center">
          {/* Timeline marker line */}
              <div className="absolute left-6 right-6 top-8 bottom-8 border-l border-demo-border border-dashed" />
              ...
              <div className="flex flex-col items-center gap-2 z-10">
                ...
                />
                <span className="text-[10px] text-demo-text-secondary font-mono">abs: 500ms</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2 z-10">
                ...
                />
                <span className="text-[10px] text-demo-text-secondary font-mono">label: start</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2 z-10">
                ...
                />
                <span className="text-[10px] text-demo-text-secondary font-mono">&lt;-=250</span>
              </div>
            </div>

            <div className="bg-[#0f0f15] p-4 rounded-lg border border-demo-border">
            ...
            <div className="space-y-2">
              ...
              <div className="relative h-1.5 w-full bg-demo-card rounded-full overflow-hidden border border-demo-border">
                <div 
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button 
                ...
                className="flex-1 px-4 py-2.5 bg-demo-border hover:bg-demo-border-hover text-white text-sm font-medium rounded-lg transition-all active:scale-95 border border-demo-border-hover"
              >
                Restart
              </button>
            </div>
...
const PositionType = ({ type, example, description }: PositionTypeProps) => (
  <div className="flex flex-col gap-1 p-2 bg-demo-card rounded-md border border-demo-border">
    <span className="text-demo-text-secondary font-semibold">{type}</span>
