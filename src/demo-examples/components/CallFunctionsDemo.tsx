...
const Display = ({ label, value }: DisplayProps) => (
  <div className="flex flex-col gap-2.5 flex-1 min-w-0">
    <span className="text-[10px] uppercase tracking-widest text-demo-text-secondary font-mono font-semibold truncate">
      {label}
    </span>
    <div className="h-20 bg-demo-bg border border-demo-border rounded-xl flex items-center justify-center relative overflow-hidden group">
      {/* Scanline effect */}
      ...
      {/* LCD Character */}
      <span className={`text-4xl font-mono font-bold transition-all duration-200 ${value ? 'text-amber-500 scale-110' : 'text-demo-card'} [text-shadow:0_0_15px_rgba(245,158,11,0.4)]`}>
        {value || '0'}
      </span>
