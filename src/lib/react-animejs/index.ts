...
// Advanced helpers — exposed for consumers building custom timeline tooling.
export { resolveTarget } from './core';
export { safeJsonStringify } from './core';
export { useTimelineContext } from './core';
