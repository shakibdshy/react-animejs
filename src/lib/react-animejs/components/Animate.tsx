import { cloneElement, forwardRef, isValidElement, type ReactElement, useEffect, useImperativeHandle, useRef } from "react";
...
export const Animate = forwardRef<HTMLElement, AnimateProps>(function Animate(
  ...
  return cloneElement(
    children,
    mergeChildProps(children as ReactElement<any>, { ref, className }),
  );
});
