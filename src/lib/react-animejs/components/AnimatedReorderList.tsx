    ...
    <div className={`flex flex-col gap-4 w-full ${className}`}>
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className="flex items-center gap-3 px-4 py-3 rounded-xl border border-[#2a2a3a] bg-[#12121a] hover:border-white/10 transition-colors group"
            >
              {/* Drag handle dots */}
