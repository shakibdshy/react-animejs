...
import { AnimeTimeline, TimelineEntry, SplitText } from "../../components";
import type { SplitTextRef, AnimeTimelineRef } from "../../components";
      ...
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#ffd11a] hover:bg-[#ffe066] text-[#12121a] rounded-lg transition-all font-bold text-xs uppercase tracking-tighter"
          >
            Play Mixed Timeline
          </button>
        </div>
