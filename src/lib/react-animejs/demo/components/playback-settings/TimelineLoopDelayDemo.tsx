  ...
  return (
    <div className="w-full bg-[#1a1a24] rounded-3xl p-6 border border-[#2a2a3a] shadow-xl">
      <div className="flex justify-between items-center mb-6">
        <h4 className="text-[#ffd11a] font-bold text-xl">loopDelay</h4>
      ...
      <div className="bg-[#302c11] rounded-2xl p-8 relative min-h-[200px] flex items-center justify-start overflow-hidden border border-[#48421a]/30">
        ...
        {isPlaying && state.progress === 1 && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/20 backdrop-blur-[2px] z-20">
            <div className="bg-[#ffd11a]/20 px-4 py-2 rounded-xl border border-[#ffd11a]/40 animate-pulse flex flex-col items-center">
              <span className="text-[#ffd11a] text-xs font-bold tracking-widest uppercase">
                Waiting loopDelay...
              </span>
              <span className="text-[#ffd11a]/60 text-[10px] font-mono mt-1">
                1000ms
              </span>
            </div>
          </div>
