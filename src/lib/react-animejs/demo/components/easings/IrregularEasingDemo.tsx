  ...
  return (
    <div className="w-full bg-[#1a1a24] rounded-3xl p-6 border border-[#2a2a3a] shadow-xl">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h4 className="text-[#ffd11a] font-bold text-xl lowercase">irregular</h4>
          <p className="text-xs text-slate-500 mt-1">Randomized stepped interpolation</p>
        </div>
      ...
      <div className="mt-3 text-[10px] text-slate-400 font-mono bg-black/30 p-2.5 rounded-lg border border-[#2a2a3a] overflow-x-auto">
