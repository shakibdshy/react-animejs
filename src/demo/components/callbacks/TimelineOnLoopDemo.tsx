  ...
  return (
    <div className="w-full bg-[#1a1a24] rounded-3xl p-6 border border-[#2a2a3a] shadow-xl">
      ...
      <div className="bg-[#0f0f13] rounded-2xl p-8 relative min-h-[160px] flex items-center justify-center border border-[#2a2a3a] overflow-hidden">
        ...
        >
          <RefreshCw
            className={`w-8 h-8 text-[#1a1a24] ${isPlaying ? "animate-spin" : ""}`}
      ...
      <div className="mt-6 flex flex-col gap-3">
        <div className="grid grid-cols-2 gap-2">
          <div className="p-3 rounded-xl bg-black/40 border border-[#2a2a3a] flex flex-col items-center">
            <span className="text-[8px] font-mono text-slate-500 uppercase tracking-widest mb-1">
              Iterations
            </span>
            <span className="text-xl font-mono font-bold text-[#ffd11a]">
              {loopCount} / 3
            </span>
          </div>
          <div className="p-3 rounded-xl bg-black/40 border border-[#2a2a3a] flex flex-col items-center">
